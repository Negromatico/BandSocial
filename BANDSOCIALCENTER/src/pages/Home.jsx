        ...
        <Modal.Body className="text-center p-5">
          ...
          <div className="d-flex flex-column align-items-center gap-2 mt-4">
            <div className="d-flex w-100 gap-3 justify-content-center">
              <Button variant="primary" size="lg" className="flex-fill" style={{ minWidth: 140 }} onClick={() => navigate('/login')}>Iniciar sesión</Button>
              <Button variant="outline-primary" size="lg" className="flex-fill" style={{ minWidth: 140 }} onClick={() => navigate('/register')}>Registrarse</Button>
            </div>
            <Button variant="secondary" size="lg" className="w-100 mt-3" style={{ minWidth: 300, fontWeight: 600, letterSpacing: 2 }} onClick={() => {
              if (typeof window !== 'undefined') {
                if (window.activateGuest) window.activateGuest();
              }
              if (guestContext && guestContext.activateGuest) guestContext.activateGuest();

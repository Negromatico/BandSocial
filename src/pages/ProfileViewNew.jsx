                    ...
                    <div className="post-actions-new">
                      ...
                      >
                        <svg 
                          ...
                          height="20" 
                          viewBox="0 0 24 24" 
                          fill={pub.likes?.includes(currentUser?.uid) ? "#ed4956" : "none"}
                          stroke={pub.likes?.includes(currentUser?.uid) ? "#ed4956" : "currentColor"}
                          strokeWidth="2"
                          strokeLinecap="round"
                        ...
                        <span style={{ 
                          color: pub.likes?.includes(currentUser?.uid) ? '#ed4956' : 'var(--text-secondary, #65676b)',
